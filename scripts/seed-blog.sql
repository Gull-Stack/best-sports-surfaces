...
<h3>Concrete</h3>
<p>A poured concrete slab is the most traditional and durable base for an outdoor basketball court. A 4-inch-thick reinforced concrete pad costs $6 to $10 per square foot, or roughly $5,400 to $9,000 for a 900-square-foot half-court. Concrete is extremely durable and can last 25 years or more with minimal maintenance. However, it is hard on joints and can become slippery when wet unless a textured finish or acrylic coating is applied.</p>
<h3>Asphalt</h3>
...
(
  ...
  '<article>
<p>Pickleball is the fastest-growing sport in America, and demand for dedicated courts has skyrocketed. Whether you are building a new court from scratch, converting a tennis court, or adding pickleball lines to an existing surface, this guide covers every detail you need to plan a successful project.</p>
...
<p>A typical new pickleball court construction project takes four to eight weeks from groundbreaking to first play. The breakdown is roughly: one to two weeks for site preparation and base work, one week for concrete or asphalt installation and curing (concrete needs at least seven days to cure before coating), one to two weeks for the acrylic coating system (applied in multiple layers with drying time between each), and one to two days for line striping and net installation.</p>
...
<h2 id="choosing-contractor">Choosing a Contractor</h2>
...
(
  ...
  '<article>
<p>Hiring the right contractor is just as important as choosing the right surface material. A poorly installed court — even with premium materials — will crack, peel, drain improperly, and fail years before it should. Conversely, a skilled contractor can make even a mid-range product perform beautifully. This guide walks you through the process of finding, evaluating, and selecting a sports surface contractor you can trust.</p>
...
<ul>
  ...
  <li><strong>ASBA Certified Builder:</strong> This designation requires passing a comprehensive exam covering sports facility design, construction, and maintenance. Certified builders have demonstrated knowledge of industry best practices. There are separate certifications for tennis courts, running tracks, and sports fields.</li>
...
<ul>
  <li>What acrylic or surface system do you use, and why? (A good contractor can explain the merits of their chosen products.)</li>
...
<p>This is the most requested residential combination. A regulation basketball half-court (50 by 47 feet) can comfortably contain one full pickleball court (20 by 44 feet) with adequate buffer space. A full basketball court can accommodate up to four pickleball courts. The acrylic hard-court surface ideal for basketball is also excellent for pickleball.</p>
<h3>Tennis and Pickleball</h3>
<p>A standard tennis court (78 by 36 feet, with 120 by 60 feet including runbacks) can host two to four pickleball courts. This is the most common conversion for community facilities looking to add pickleball capacity. Both sports play well on acrylic surfaces.</p>
...
<ol>
  ...
  <li><strong>Create a scaled layout:</strong> Draw the court to scale, starting with the primary sport and overlaying secondary sports. A qualified contractor or court designer can do this for you.</li>
...
<h2 id="acrylic-hard-courts">Acrylic Hard Court Maintenance</h2>
...
<h2 id="clay-court-maintenance">Clay Court Maintenance (Har-Tru and Red Clay)</h2>
...
<p><strong>Mold and algae growth:</strong> Humid environments promote biological growth on court surfaces, especially in shaded areas. Acrylic courts in the Southeast United States often develop green or black algae within months of resurfacing. Regular pressure washing and algaecide treatment are essential maintenance tasks.</p>
...
<p>Commercial sports courts almost always adhere to official governing body dimensions. A commercial tennis court must be 78 by 36 feet with a minimum of 12 feet of runback behind each baseline and 6 feet on each side — totaling a minimum 120 by 60-foot footprint. A commercial basketball court follows NCAA (84 by 50 feet) or NBA (94 by 50 feet) dimensions with specified clearances.</p>
...
(
  ...
  '<article>
<p>As environmental awareness grows across all industries, the sports surface sector is facing increasing scrutiny about the sustainability of its products and practices. From the petroleum-based polymers in synthetic turf to the water demands of natural grass, every surface choice carries environmental implications. This guide examines the environmental impact of the most common sports surface materials and highlights emerging sustainable alternatives.</p>
...
<h2 id="acrylic-surfaces-impact">Acrylic Court Surfaces</h2>
