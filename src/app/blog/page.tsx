  ...
  return (
    <div className="max-w-7xl mx-auto px-4 py-12">
      <div className="text-center mb-10">
        <h1 className="text-3xl font-bold text-text-primary">Sports Surface Blog</h1>
            ...
            <Link key={post.id} href={`/blog/${post.slug}`}>
              <Card hover padding="none" className="h-full flex flex-col">
                ...
                <div className="p-5 flex-1 flex flex-col">
                  ...
                  <h2 className="text-lg font-semibold text-text-primary mb-2 line-clamp-2 group-hover:text-neon">
                    {post.title}
                  </h2>
                  <p className="text-sm text-text-secondary line-clamp-3 flex-1">{post.excerpt}</p>
                  <span className="text-sm text-neon font-medium mt-3 inline-block">
                    Read more &rarr;
                  </span>
                </div>
              </Card>
