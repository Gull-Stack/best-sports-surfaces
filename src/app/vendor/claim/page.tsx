...
export default function VendorClaimPage() {
  ...
  return (
    <div className="max-w-md mx-auto px-4 py-12">
      <h1 className="text-2xl font-bold text-gray-900 mb-2 text-center">Claim Your Listing</h1>
      <p className="text-gray-600 text-center mb-6">Verify your ownership to manage your business listing.</p>
      <Card padding="lg">
